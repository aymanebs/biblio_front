...
const Jumbotron = ()=>{
    return(
        ...
        <section className="bg-center bg-no-repeat bg-[url('/imgs/library.jpg')] bg-gray-700 bg-blend-multiply">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-40  ">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                        Get started
